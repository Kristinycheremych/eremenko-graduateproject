...
const AddTaskIntegrationStage = () => {
    ...
    const handleAddTask = async () => {
        try {
            await axios.post(`http://localhost:3001/projects/${projectId}/integrationStage/${stageId}/tasks`,
                {
                    title: newTaskTitle,
            ...
            window.location.href = `/projectsPage/projectDetails/${projectId}/boards/integration`;
        } catch (error) {
                ...
                <div className={'wrapper'}>
                    <form onSubmit={handleAddTask}>
                        ...
                        <div className={'action_buttons'}>
                            <Link to={`/projectsPage/projectDetails/${projectId}/boards/integration`}><button className={'btn_add_cancel'}>Отменить</button></Link>
...
export default AddTaskIntegrationStage
