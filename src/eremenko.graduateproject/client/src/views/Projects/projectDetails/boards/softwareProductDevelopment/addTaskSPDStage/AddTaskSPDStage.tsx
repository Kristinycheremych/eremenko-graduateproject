...
const AddTaskSPDStage = () => {
    ...
    const handleAddTask = async () => {
        try {
            await axios.post(`http://localhost:3001/projects/${projectId}/SPDStage/${stageId}/tasks`,
                {
                    title: newTaskTitle,
            ...
            window.location.href = `/projectsPage/projectDetails/${projectId}/boards/softwareProductDevelopment`;
        } catch (error) {
...
export default AddTaskSPDStage
