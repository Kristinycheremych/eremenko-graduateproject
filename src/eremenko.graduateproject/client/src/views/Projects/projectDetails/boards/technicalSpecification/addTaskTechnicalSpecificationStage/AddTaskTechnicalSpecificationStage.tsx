...
const AddTaskTechnicalSpecificationStage = () => {
    ...
    const handleAddTask = async () => {
        try {
            await axios.post(`http://localhost:3001/projects/${projectId}/TechnicalSpecificationStage/${stageId}/tasks`,
                {
                    title: newTaskTitle,
            ...
            window.location.href = `/projectsPage/projectDetails/${projectId}/boards/technicalSpecification`;
        } catch (error) {
...
export default AddTaskTechnicalSpecificationStage
